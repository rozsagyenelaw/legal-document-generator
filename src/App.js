...
Each successor Trustee serving under this agreement, whether corporate or individual, will have all of the title, rights, powers and privileges granted to the initial Trustee named under this agreement. In addition, each successor Trustee is subject to all of the restrictions imposed upon, as well as all obligations and duties, both discretionary and ministerial, given to the initialTrustee named under this agreement. 
...
If I have no then-living descendants, the Trustee shall distribute the balance of the trust property as provided in Article Five. 
...
I waive all duties of the Trustee to give notice, information, and reports to any Qualified Beneficiaries other than me while I am alive and able to effectively manage my financial resources. The Trustee is not required to keep Qualified Beneficiaries of any trust created under this trust other than me informed of the trust administration in any manner. Further, the Trustee is not required to respond to any request for information related to the trust administration from anyone whois not a Qualified Beneficiary, other than me. 

(b) Providing Information If I Am Alive but Incapacitated, and after 
My Death
...
The Trustee may make loans to, or guarantee the borrowing of, any person including a beneficiary, as well as an entity, trust, or estate, for any term or payable on demand, and secured or unsecured. But the Trustee may only make loans to me with adequate interest and security. 
...
Except as otherwise provided in this trust, the Trustee may pay any property taxes, assessments, fees, charges, and other expenses incurred in the administration or protection of the trust. All payments will be a charge against the trust property and will be paid by the 

Trustee out of income. If the income is insufficient, then the Trustee may make any payments of property taxes or expenses out of the trust property’s principal. The Trustee’s determination with respect to this payment will be conclusive on the beneficiaries. 
...
Following my death or in the event of my permanent disability, I prefer that the Trustee sell any interest in a professional practice owned by the trust as quickly as practicable in order to protect the value of the practice. The Trustee may sell my interest in the professional practice on terms the Trustee considers appropriate. 
...
Section 8.17 Purchase of Assets from and Loans to My Probate Estate 
...
(1) Protection of S CorporationStatus
...
(a) An Interested Trustee Limited to AscertainableStandards
...
(d) No Distributions in Discharge of Certain LegalObligations

The Trustee may not exercise or participate in the exercise of discretion with respect 
to the distribution of income or principal that would in any manner discharge a legal obligation of the Trustee, including the obligation of support. 
If a beneficiary or any other person has the power to remove a Trustee, that Trustee 
may not exercise or participate in the exercise of discretion with respect to the distribution of income or principal that would in any manner discharge a legal obligation of the person having the power to remove the Trustee, including that person’s obligation of support. 
...
If any rule of law or court decision construes the ability of the insured Trustee to name an Independent Special Trustee as an incident of ownership of the policy, 
then a majority of the then current Income Beneficiaries (excluding the insured Trustee if he or she is a beneficiary) will select the Independent Special Trustee. 

(f) Insurance Policy on a Beneficiary’s Life

If the trust holds a policy that insures a beneficiary’s life, the beneficiary, 
individually or as Trustee, may not exercise any power over the policy, its cash 
value, or its proceeds. This denial of power is intended to prevent an insured 
beneficiary from holding any power that would constitute an incident of ownership 
of the policy. 
...
1) The Opinion of Two LicensedPhysicians
...
describe the circumstances of the individual’s disappearance, absence, or detention, and may be relied upon by any third party dealing in good faith with the Trustee. 
...
(l) Internal Revenue Code and TreasuryRegulations
...
(c) Headings of Articles, Sections, andSubsections
...
Unless otherwise stated, any notice required under this trust will be in writing. The notice may be personally delivered with proof of delivery to the party requiring notice and will be effective on the date personally delivered. Notice may also be mailed, postage prepaid, by certified mail with return receipt requested to the last known address of the party requiring notice. Mailed notice is effective on the of the return receipt. If a party giving notice does not receive the return receipt but has proof that he or she mailed the notice, notice will be effective on the date it would normally have been received via certified mail. If the party requiring notice is a minor or incapacitated individual, notice will be given to the parent or Legal Representative. 
